...
namespace ComfortHealthCare.Presentation.Pages
{
    public class DoctorModel : PageModel
    {
        ...
        public async Task OnGetAsync(int pageNumber = 1)
        {
            ...
            var jsonString = await _apiClient.GetdoctorbynumberAsync(10, new CancellationTokenSource().Token);
          ...
          //  var totalDoctors = await _apiClient.GetTotalDoctorsCountAsync(new CancellationTokenSource().Token);
